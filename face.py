...
vinod_image = face_recognition.load_image_file("namitha.jpg")
vinod_face_encoding = face_recognition.face_encodings(vinod_image)[0]

# Load a second sample picture and learn how to recognize it.
swapna_image = face_recognition.load_image_file("swapna.jpg")
swapna_face_encoding = face_recognition.face_encodings(swapna_image)[0]

# Load a third sample picture and learn how to recognize it.
sreerag_image = face_recognition.load_image_file("sreerag.jpg")
...
shaiju_image = face_recognition.load_image_file("shaiju.jpg")
...
anil_image = face_recognition.load_image_file("anil.jpg")
